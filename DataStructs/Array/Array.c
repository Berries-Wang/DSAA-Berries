...
void swap_array(Array array, int index1, int index2) {

    VALUETYPE val = getEle_Array(array, index1);
    setEle_Array(array, index1, getEle_Array(array, index2));
    setEle_Array(array, index2, val);
}
